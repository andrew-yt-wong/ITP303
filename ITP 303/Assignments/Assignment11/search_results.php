			...
			<div class="col-12">
				<table class="table table-hover table-responsive mt-4">
					...
					<tbody>
						...
						<tr>
							<td>
								<a onclick="return false confirm('Are you sure you want to delete this dvd?')" href="delete.php?dvd_title_id=<?php echo $row['dvd_title_id']?>&title=<?php echo $row['title']?>" class="btn btn-outline-danger delete-btn">
									Delete
								</a>
							</td>
							<td>
